...
with open('/Users/jacksonoppenheim/Documents/MTGRNN/Cards/WAR/PWAR.json', 'r') as f:
    DOM_dict = j.load(f)

#Whole Card File
cardWhole = open("/Users/jacksonoppenheim/Documents/MTGRNN/Cards/WAR/PWAR.txt", "w")
